...
public class TextEmbedder {
  ...
  public static void main(final String[] args) throws Exception {
    ...
    final TextEmbedding[] hitEmbeddings =
        {embedder.embed("hitDoc1.txt", "Lucene is a powerful search library."),
            embedder.embed("hitDoc2.txt",
                "BM25Similarity is the default search term similarity algorithm."),
  ...
  public TextEmbedder() {
    ...
    embeddingModel = OpenAiEmbeddingModel.builder().apiKey(apiKey).modelName(embeddingModelName)
        .dimensions(embeddingDimensions).build();
  }
