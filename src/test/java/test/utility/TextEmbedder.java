...
public class TextEmbedder {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final TextEmbedding[] hitEmbeddings = {
            ...
            embedder.embed("hitDoc2.txt", "BM25Similarity is the default search term similarity algorithm."),
        ...
        final TextEmbedding query1 = embedder.embed("query1.txt", "Give me information on the lucine search library");
        query1.toFile();
